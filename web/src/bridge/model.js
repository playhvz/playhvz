...
var models = {
  gun: {
    ...
    path: ['games', 'gameId', 'guns'], // To whom this object belongs
  ...
  message: {
    ...
    path: ['games', 'gameId', 'chatRooms', 'chatRoomId', 'messages'],
    message: '',
    image: '',
    index: '',
    location: '',
  ...
  quizQuestion: {
    ...
    path: ['games', 'gameId', 'quizQuestions'],
    answers: [],
    text: '',
    type: '',
    number: 0,
  ...
  quizAnswer: {
    ...
    path: ['games', 'gameId', 'quizQuestions', 'quizQuestionId', 'answers'],
    isCorrect: false,
    order: 0,
    text: '',
    number: 0
  ...
  rewardCategory: {
    ...
    path: ['games', 'gameId', 'rewardCategories'],
    badgeImageUrl: '',
    claimed: 0,
    description: '',
    gameId: '',
  ...
  reward: {
    ...
    path: ['games', 'gameId', 'rewardCategories', 'rewardCategoryId', 'rewards'],
    code: '',
    playerId: '',
    rewardCategoryId: '',
    gameId: ''
  ...
  admin: {
    ...
    path: ['games', 'gameId', 'adminUsers'],
    userId: '',
    gameId: '',
  },
  claim: {
    link: ['publicPlayers', 'playerId', 'claims', 'rewardId'],
    path: ['games', 'gameId', 'players', 'playerId', 'claims'],
    rewardCategoryId: '',
    rewardId: '',
    time: 0,
    gameId: '',
  ...
  playerChatRoomMembership: {
    ...
    path: ['games', 'gameId', 'players', 'publicPlayerId', 'private', 'chatRoomMemberships'],
    chatRoomId: '',
    publicPlayerId: '',
    privatePlayerId: '',
    gameId: '',
  ...
  playerMissionMembership: {
    ...
    path: ['games', 'gameId', 'players', 'playerId', 'private', 'missionMemberships'],
    missionId: '',
    playerId: '',
    gameId: '',
  },
  infection: {
    ...
    path: ['games', 'gameId', 'players', 'playerId', 'infections'],
    time: 0,
    infectorId: 0,
    infectionId: '',
    gameId: '',
  ...
  publicLife: {
    ...
    path: ['games', 'gameId', 'players', 'playerId', 'lives'],
    time: 0,
    private: '',
    privateLifeId: '',
    gameId: ''
  ...
  privateLife: {
    ...
    path: ['games', 'gameId', 'players', 'playerId', 'lives', 'lifeId', 'private'],
    code: '',
    gameId: '',
  },
  publicPlayer: {
  ...
  privatePlayer: {
    ...
    path: ['games', 'gameId', 'players', 'playerId', 'private'],
    isActive: false,
    beInPhotos: false,
    userId: '',
    gameId: '',
